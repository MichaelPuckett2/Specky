    ...
    public class SpeckActivator : ISpeckActivator
    {
        ...
        public object InstantiateSpeck(Type type, IEnumerable<Speck> specks)
        {
            ...
            foreach (var contructorArg in contructorArgs)
            {
                ...
                {
                    var paramSpeck = GetSpeck(parameter.ParameterType, specks); // specks.FirstOrDefault(x => x.Type == parameter.ParameterType);
                    if (paramSpeck == null)
                    {
                ...
                {
                    instance = Activator.CreateInstance(speck.Type, instances);
                }
